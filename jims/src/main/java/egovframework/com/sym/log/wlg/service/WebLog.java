...
public class WebLog implements Serializable {
	 ...
	 * 파라미터
	 */
	private String rqesterParam = "";
	
	/**
	 * 메뉴id
	 */
	private String rqesterMenuId = "";
	...
	/**
	 * @return the rqesterParam
	 */
	public String getRqesterParam() {
		return rqesterParam;
	}
	/**
	 * @param rqesterParam the rqesterParam to set
	 */
	public void setRqesterParam(String rqesterParam) {
		this.rqesterParam = rqesterParam;
	}
	/**
	 * @return the rqesterMenuId
	 */
	public String getRqesterMenuId() {
		return rqesterMenuId;
	}
	/**
	 * @param rqesterMenuId the rqesterMenuId to set
	 */
	public void setRqesterMenuId(String rqesterMenuId) {
		this.rqesterMenuId = rqesterMenuId;
	}
	/**
	 * @return the guid
	 */
