...
public class EgovWebLogServiceImpl extends EgovAbstractServiceImpl implements
	...
	/* (non-Javadoc)
	 * @see egovframework.com.sym.log.wlg.service.EgovWebLogService#InsertLogWebLog(egovframework.com.sym.log.wlg.service.WebLog)
	 */
	@Override
	public void InsertLogWebLog(WebLog webLog) throws Exception {
		String requstId = egovWebLogIdGnrService.getNextStringId();
		webLog.setRequstId(requstId);
